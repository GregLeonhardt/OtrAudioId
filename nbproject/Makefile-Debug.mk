...
${OBJECTDIR}/dbase/dbase_lib_episode.o: dbase/dbase_lib_episode.c
	${MKDIR} -p ${OBJECTDIR}/dbase
	${RM} "$@.d"
	$(COMPILE.c) -g -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dbase/dbase_lib_episode.o dbase/dbase_lib_episode.c

${OBJECTDIR}/dbase/dbase_lib_file.o: dbase/dbase_lib_file.c
	${MKDIR} -p ${OBJECTDIR}/dbase
	${RM} "$@.d"
	$(COMPILE.c) -g -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dbase/dbase_lib_file.o dbase/dbase_lib_file.c

${OBJECTDIR}/dbase/dbase_lib_show.o: dbase/dbase_lib_show.c
	${MKDIR} -p ${OBJECTDIR}/dbase
	${RM} "$@.d"
	$(COMPILE.c) -g -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dbase/dbase_lib_show.o dbase/dbase_lib_show.c
