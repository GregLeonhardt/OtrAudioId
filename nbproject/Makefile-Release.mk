...
${OBJECTDIR}/add/add_api.o: add/add_api.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/add/add_api.o add/add_api.c

${OBJECTDIR}/add/add_lib.o: add/add_lib.c
	${MKDIR} -p ${OBJECTDIR}/add
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/add/add_lib.o add/add_lib.c

${OBJECTDIR}/create/create_api.o: create/create_api.c
	${MKDIR} -p ${OBJECTDIR}/create
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/create/create_api.o create/create_api.c

${OBJECTDIR}/create/create_lib.o: create/create_lib.c
	${MKDIR} -p ${OBJECTDIR}/create
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/create/create_lib.o create/create_lib.c
...
${OBJECTDIR}/dbase/dbase_api_episode.o: dbase/dbase_api_episode.c
	${MKDIR} -p ${OBJECTDIR}/dbase
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dbase/dbase_api_episode.o dbase/dbase_api_episode.c

${OBJECTDIR}/dbase/dbase_api_file.o: dbase/dbase_api_file.c
	${MKDIR} -p ${OBJECTDIR}/dbase
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dbase/dbase_api_file.o dbase/dbase_api_file.c

${OBJECTDIR}/dbase/dbase_api_show.o: dbase/dbase_api_show.c
	${MKDIR} -p ${OBJECTDIR}/dbase
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dbase/dbase_api_show.o dbase/dbase_api_show.c
...
${OBJECTDIR}/id3/id3_api.o: id3/id3_api.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/id3/id3_api.o id3/id3_api.c

${OBJECTDIR}/id3/id3_lib.o: id3/id3_lib.c
	${MKDIR} -p ${OBJECTDIR}/id3
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/id3/id3_lib.o id3/id3_lib.c
...
${OBJECTDIR}/mp3/mp3_api.o: mp3/mp3_api.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mp3/mp3_api.o mp3/mp3_api.c

${OBJECTDIR}/mp3/mp3_lib.o: mp3/mp3_lib.c
	${MKDIR} -p ${OBJECTDIR}/mp3
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mp3/mp3_lib.o mp3/mp3_lib.c
